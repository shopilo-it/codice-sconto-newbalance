#!/usr/bin/env python3
"""
Recupero codici sconto New Balance da shopilo.it
Sursa: https://shopilo.it/negozi/newbalance.it
"""
...
SHOPILO_URL = "https://shopilo.it/negozi/newbalance.it"
STORE_NAME = "New Balance"


def fetch_coupons(url=SHOPILO_URL):
    """Restituisce la lista dei coupon attivi per New Balance da shopilo.it"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-it/codice-sconto-newbalance)"
    }
    try:
